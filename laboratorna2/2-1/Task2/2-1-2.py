...
class Order:
    ...
    @property
    def get_menu(self):
        return '\n'.join([f'{i}' for i in self._extra.products_data[self._extra.string_name]])
...
if result.lower() == "yes":
    ...
    print(my_order.get_menu)
    my_order.change_pizza(input())
